...
import { Meeting, MeetingStatus, MeetingNote, MeetingLog } from '../types/meeting.types';
import { logger } from '@polaris/runtime';
...
export class MeetingModel {
  ...
  static createFromInput(input: any, userId: string): MeetingModel {
    ...
    model.data.agenda = input.agenda ? input.agenda.split('\n').filter(Boolean) : [];
